...
> **Роль:** автор проєкту / Python-розробник — ігрові системи, власний редактор рівнів, профілювання й оптимізація продуктивності, інтеграція локалізації та процес збірки/випуску Windows-версії.
...
<p align="center">
  <img src="assets/gameplay/gameplay-demo.gif" alt="Демонстрація ігрового процесу Cat vs Ghosts" width="100%">
</p>

<p align="center"><em>Демонстрація ігрового процесу — платформінг, бій і кілька різних локацій кампанії.</em></p>
<p align="center"><a href="assets/gameplay/gameplay-demo.mp4">▶ Переглянути MP4-демо</a></p>
...
<p align="center">
  <img src="assets/editor/editor-demo.gif" alt="Демонстрація власного редактора рівнів Cat vs Ghosts" width="100%">
</p>
...
## Статус проєкту
**Cat vs Ghosts 1.0.0** завершено. Цей репозиторій є публічною вітриною проєкту; production-код і Windows-збірка тут не розповсюджуються.
...
## Ліцензія
Цей showcase опубліковано на умовах власної proprietary-ліцензії для портфоліо. Докладніше — у файлі [LICENSE](LICENSE).
